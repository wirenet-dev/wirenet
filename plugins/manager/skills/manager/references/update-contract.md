...
- `project-lifecycle.md` classifies an untracked workspace as `project`,
  `experiment`, or `ignored`, then uses the deterministic helper after approval.
- `workspace-sync.md` consumes that established classification; it does not
...
- Route transitions and promotions through `project-lifecycle.md`, which
