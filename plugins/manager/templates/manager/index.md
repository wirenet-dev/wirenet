...
`people/`, `notes/`, `docs/`, `sources/`, `experiments/`, and `archive/` receive
typed concepts as needed. Add a shelf-local `index.md` only when real content
benefits from progressive disclosure; do not seed empty catalog pages.
