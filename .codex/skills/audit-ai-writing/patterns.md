...
- Invalid or hallucinated wiki structures: invented templates or categories, pre-placed maintenance templates, AfC "submission statement" residue, unused named references dumped into a references section.
